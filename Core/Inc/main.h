...
#define IS_CHRG_Pin GPIO_PIN_10
#define IS_CHRG_GPIO_Port GPIOE
#define SPI_CS_Pin GPIO_PIN_11
#define SPI_CS_GPIO_Port GPIOE
#define USB_IN_Pin GPIO_PIN_12
...
#define OLED_VCC_EN_Pin GPIO_PIN_10
#define OLED_VCC_EN_GPIO_Port GPIOB
#define OLED_VDD_EN_Pin GPIO_PIN_11
#define OLED_VDD_EN_GPIO_Port GPIOB
